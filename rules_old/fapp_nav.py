...
def extract_urls_from_rules(file_input, file_output, analytics_file, analytics_200_file, processed_urls_file, debug_mode, use_selenium, driver):
    processed_urls = set()
...
def process_all_rules_files(debug_mode=False, use_selenium=False):
    ...
    # Configura o Selenium, se necessário
    driver = configure_selenium() if use_selenium else None
    ...
    for file_input in files:
        ...
        print(f"Processando {file_input}...")
        extract_urls_from_rules(input_path, output_path, analytics_file, analytics_200_file, processed_urls_file, debug_mode, use_selenium, driver)
        print(f"Resultado salvo em {output_path}")

    # Fecha o driver Selenium se estiver em uso
    if driver:
        driver.quit()

# Configurações
# debug_mode = True exibe resultados na tela em tempo real
# use_selenium = True utiliza Selenium para navegação
